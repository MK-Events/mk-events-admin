...
const Logo = ({ size, relativeSize, type, theme, logoText }: LogoProps) => {
  ...
  const getSize = useCallback(() => {
    ...
    const iconDefaultRelativeSize =
      isMobile && !isTablet
        ? config.global.logoSize.sm
        : config.global.logoSize.md;

    const logoDefaultRelativeSize =
      isMobile && !isTablet
        ? config.global.logoSize.lg
        : config.global.logoSize.xl;
    ...
    switch (relativeSize) {
      ...
      default:
        return type === "icon"
          ? iconDefaultRelativeSize
          : logoDefaultRelativeSize;
    }
  }, [
    size,
    relativeSize,
